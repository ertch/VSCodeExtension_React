...
import Input_String from '../../inputs/Input_String'
import Input_Checkbox from '../../inputs/Input_Checkbox'
import Input_Function from '../../inputs/Input_Function'
import Input_DoubleSingle from '../../inputs/Input_DoubleSingle'
import Input_TrippleSingle from '../../inputs/Input_TrippleSingle'
...
export default function BaseCard({ id, config, slotProps }: BaseCardProps) {
  ...
  const renderInput = (attr: CardAttribute) => {
    switch (attr.type) {
      ...
      case 'checkbox':
        return <Input_Checkbox name={attr.name} />
      case 'function':
        return <Input_Function name={attr.name} />
      case 'double_single':
        return <Input_DoubleSingle name={attr.name} />
      case 'tripple_single':
        return <Input_TrippleSingle name={attr.name} />
      case 'tripple_list':
