...
const snippetDefinitions = {
    ...
    'Gatekeeper': {
        attributes: { id: '', label: '', options: '', actions: '', gate: '', submitTo: '', pageLock: '', required: '' },
        childs: {}
    },
    'Gate': {
...
function activate(context) {
    let disposable = vscode.commands.registerCommand('vscExtension.showWebview', () => {
        ...
        mainPanel = vscode.window.createWebviewPanel('extensionWebview', 'Astro Code Generator', vscode.ViewColumn.One, {
            enableScripts: true,
