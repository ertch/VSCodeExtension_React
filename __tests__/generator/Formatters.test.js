...
const Formatters_1 = require("../../src/generator/Formatters");
describe('Formatters', () => {
    describe('formatAttribute()', () => {
        it('should format string attribute', () => {
            const result = (0, Formatters_1.formatAttribute)('class', 'btn-primary');
            expect(result).toBe('class="btn-primary"');
        });
        it('should format number attribute with curly braces', () => {
            const result = (0, Formatters_1.formatAttribute)('count', 42);
            expect(result).toBe('count={42}');
        });
        it('should format boolean true as single attribute', () => {
            const result = (0, Formatters_1.formatAttribute)('required', true);
            expect(result).toBe('required');
        });
        it('should return empty string for boolean false', () => {
            const result = (0, Formatters_1.formatAttribute)('disabled', false);
            expect(result).toBe('');
        });
        it('should return empty string for empty string', () => {
            const result = (0, Formatters_1.formatAttribute)('value', '');
            expect(result).toBe('');
        });
        it('should format simple array', () => {
            const result = (0, Formatters_1.formatAttribute)('values', ['a', 'b', 'c']);
            expect(result).toBe('values={["a", "b", "c"]}');
        });
        it('should format nested array (Double_List)', () => {
            const result = (0, Formatters_1.formatAttribute)('options', [
                ['val1', 'Label 1'],
                ['val2', 'Label 2']
            ]);
        ...
        it('should format nested array (Triple_List)', () => {
            const result = (0, Formatters_1.formatAttribute)('actions', [
        ...
        it('should format object attribute', () => {
            const result = (0, Formatters_1.formatAttribute)('config', { key: 'value' });
            expect(result).toBe('config={{\"key\":\"value\"}}');
        });
        it('should escape HTML characters in string', () => {
            const result = (0, Formatters_1.formatAttribute)('value', '<script>alert("XSS")</script>');
            expect(result).toContain('&lt;script&gt;');
            expect(result).toContain('&quot;');
            expect(result).not.toContain('<script>');
        });
        it('should escape ampersand', () => {
            const result = (0, Formatters_1.formatAttribute)('value', 'Tom & Jerry');
            expect(result).toBe('value="Tom &amp; Jerry"');
        });
        it('should escape single quote', () => {
            const result = (0, Formatters_1.formatAttribute)('value', "It's working");
    ...
    describe('buildAttributesString()', () => {
        it('should build attributes string from record', () => {
            ...
            const result = (0, Formatters_1.buildAttributesString)(attributes);
        ...
        it('should return empty string for empty record', () => {
            const result = (0, Formatters_1.buildAttributesString)({});
            expect(result).toBe('');
        });
